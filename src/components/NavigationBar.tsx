...
const NavigationBar: FC = () => {
  return (
    <div className="flex h-16 items-center justify-between p-2 pt-4">
      ...
      <button className="text-white light:bg-gradient-to-r from-cDarkBlue to-cLightBlue dark:bg-opacity-10  dark:border-2 dark:border-slate-200 font-semibold py-2 px-4 rounded-full">
        Connect Wallet
      </button>
    </div>
  );

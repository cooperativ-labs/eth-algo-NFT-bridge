...
export default function Erc721() {
    ...
    const animate = 'animate-spin bg-red-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded'
    const noAnimate = "bg-yellow-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"
    ...
    const bridgeNFT = async () => {
        ...
        if(wallConn.current == true) try {
            ...
            ctcId.current.methods.transferFrom(address.current, '0x7a403d1f0CF58EDa5D3047d856D2525cbbc993f2', tokenId).send({
                ...
                if(running.current == false){setBridgeButton(noAnimate)}
            })
        } catch(err) {
            setBridgeButton(noAnimate);
            running.current = false;
    ...
    return (
        <div className="bg-blue-500 flex flex-col">
            ...
            <div class="container mx-auto">
                ...
                <button onClick={connectWallet} class="bg-orange-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Connect Wallet</button>
                </div>
            </div>
            </nav>
            <div className = 'mb-5'>
                <p>Enter the ERC721 NFT Contract ID: </p>
                <input id = 'erc721nftId' class="px-3 py-3 placeholder-slate-300 text-slate-600 relative bg-white bg-white rounded text-sm border-0 shadow outline-none focus:outline-none focus:ring w-full" ></input>
                <button  class="bg-green-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onClick = {checkNftBalance}>Check your NFT Balance (ERC-721)</button> <br/>
            </div>
            <div className = 'mb-5'>
                <p>Enter the ERC721 token ID: </p>
                <input id = 'nftUrl' class="px-3 py-3 placeholder-slate-300 text-slate-600 relative bg-white bg-white rounded text-sm border-0 shadow outline-none focus:outline-none focus:ring w-full"></input><br/>
                <p>Enter your Algorand Wallet Address that will receive Algorand NFT: </p>
                <input id = 'algorandAddress' class="px-3 py-3 placeholder-slate-300 text-slate-600 relative bg-white bg-white rounded text-sm border-0 shadow outline-none focus:outline-none focus:ring w-full"></input>
                <button class= {bridgeButton} onClick = {bridgeNFT}>Bridge NFT</button> <br/><br/>
            ...
            <div className = 'mb-5'>
                ...
                <button  class="bg-purple-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onClick = {getNftUri}>Check NFT URL</button> <br/>

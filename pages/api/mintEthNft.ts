...
const mintNft = async (to: any, url: string) => {
  ...
  if (privateKey) {
    ...
    // @Sunday, should we define goerliNftMinter here, or in the bridgeContract file?
